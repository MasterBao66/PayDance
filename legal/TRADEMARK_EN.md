...
- Accurately state that your project is "based on PayDance", "forked from PayDance", or "compatible with PayDance"
- Link to the official repository, website, or Release page
